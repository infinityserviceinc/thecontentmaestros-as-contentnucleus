...
<head>
  <title>thecontentmaestros | Secure Payment</title>
   ...
   <div class="main_nav">
        <div class="container">   
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand logo" href="index.php" data-aos="fade-down" data-aos-duration="1000"> <img class="img-fluid" src="images/slogo.png" alt="" style="width:90px"> </a>
				...
				<div class="cardInfo">
					<div class="card myCardPay" >
						<div class="card-header text-center text-black">
							<h2 class="card-heading" style="color:black;">Invoice from thecontentmaestros</h2>
