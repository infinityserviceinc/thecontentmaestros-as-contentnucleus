...
<meta name="twitter:url" content="https://thecontentmaestros.co.uk/our-services/content-writing"/>                  
                    
      

<meta property="og:title" content="Best Content Writing Services | CCW"/>
<meta property="og:type" content="article"/>
<meta property="og:url" content="https://thecontentmaestros.co.uk/our-services/content-writing"/>
...
<!--              <input type="hidden" id="location" name="locationURL" value="http://thecontentmaestros.co.uk/our-services/content-writing" />-->
<!--               </div>-->
...
<input type="hidden" name="route" value="<?= $_SERVER['REQUEST_URI']?>">   
                  ...
                  <input type="text" class="jun"  name="gender" > 
                    ...
                    <div class="row">
                      ...
                      <input type="hidden" name="hiddencapcha" value="">
                      <input type="hidden" id="flocation" name="locationURL" value="http://thecontentmaestros.co.uk/our-services/content-writing" />
                        </div>
                      </div>
                    </div>
                  </form>
...
<section class="listsec">
  <div class="container">
    <div class="row">
      <h2>The Content Maestros WORKS FOR B2B and B2C COMPANIES </h2>
