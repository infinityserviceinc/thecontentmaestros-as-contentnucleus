          ...
          <div class="container align-self-center">
            <div class="row">
              <div class="banner_left align-items-center">
                <h1>Professional Letter Writing Services For Everyone
                  <!-- <span id="typed" style="white-space:pre; color:#2e3390;" class="typed"></span><span
                    class="typed-cursor"></span> -->
                </h1>
                <p class="text-center">
                  We are home to letter-writing experts who can help you craft custom-written letters through methodical writing and ingenious wordplay, conveying the message in style
                </p>
                <!-- <h4 class="sf-txt">
                  Starting from only 
