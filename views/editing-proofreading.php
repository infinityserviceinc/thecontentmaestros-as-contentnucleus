...
<meta name="twitter:url" content="https://thecontentmaestros.co.uk/our-services/editing-proofreading"/>                 
...
<meta property="og:url" content="https://thecontentmaestros.co.uk/our-services/editing-proofreading"/>
...
<!--              <input type="hidden" id="location" name="locationURL" value="http://thecontentmaestros.co.uk/our-services/editing-proofreading" />-->
<!--               </div>-->
...
<input type="hidden" name="route" value="<?= $_SERVER['REQUEST_URI']?>">   
                  ...
                  <input type="text" class="jun"  name="gender" > 
                    ...
                    <div class="row">
                      ...
                      <input type="hidden" name="hiddencapcha" value="">
                      <input type="hidden" id="flocation" name="locationURL" value="http://thecontentmaestros.co.uk/our-services/editing-proofreading" />
                        </div>
                      </div>
                    </div>
                  </form>
