...
<meta name="twitter:url" content="https://contentnucleus.co.uk/our-services/editing-proofreading"/>                 
...
<meta property="og:url" content="https://contentnucleus.co.uk/our-services/editing-proofreading"/>
...
<body class="ghostwriting-page edng-page">
...
<!--              <input type="hidden" id="location" name="locationURL" value="http://contentnucleus.co.uk/our-services/editing-proofreading" />-->
<!--               </div>-->
...
<input type="hidden" name="route" value="<?= $_SERVER['REQUEST_URI']?>">   
                  ...
                  <input type="text" class="jun"  name="gender" > 
                    ...
                    <div class="row">
                      ...
                      <input type="hidden" name="hiddencapcha" value="">
                      <input type="hidden" id="flocation" name="locationURL" value="http://contentnucleus.co.uk/our-services/editing-proofreading" />
                        </div>
                      </div>
                    </div>
                  </form>
...
<section class="main-ghst-writng-first-sec sec-padding-60" style="background-image: linear-gradient(to bottom right, #353631 0%,#72775c 100%);">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="ghst-writng-content">
           <h1>Grammatically, Idiomatically, Structurally—unerringly correct:</h1>
           <p>Brush off the errors and flaws fouling your document’s appeal with our eye-to-detail experts.</p>
...
<section class="main-ghst-writng-thierd-sec sec-padding-60 main-ednt-img-sec">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="thierd-sec-img">
          <figure>
            <img src="../assets/images/services/editing/are-you-struggling.png" alt="" />
          </figure>
        </div>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-12">
...
<!--<section class="collaboration-sec main-qltedit-img-sec">-->
<!--  <div class="container">-->
<!--    <div class="row align-items-center">-->
<!--      <div class="col-lg-6 col-md-6 col-sm-12">-->
<!--        <div class="wrapper">-->
<!--          <h3>Quality Editing & Proofreading</h3>-->
<!--          <h2>Thorough and skilful Editing and Proofreading Service </h2>-->
<!--          <p>Do you want someone to go through your content before you post it live? Our professional editors and proof readers have years of experience and market knowledge. We find and fix errors, and ensure that your copy looks perfect!</p>-->
<!--          <a href="http://contentnucleus.co.uk/order" class="btn-theme">Let’s Get Started</a>-->
<!--        </div>-->
<!--      </div>-->
<!--      <div class="col-lg-6 col-md-6 col-sm-12">-->
<!--        <figure>-->
<!--          <img src="../assets/images/services/editing/thorough-and-skilful-editing.png">-->
<!--        </figure>-->
<!--      </div>-->
<!--    </div>-->
<!--  </div>-->
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="main-ser">
          <div class="ser-box2">
             <ul>
               <li>Re-writing and re-structuring</li>
               <li>Developmental editing </li>
               <li>Bringing consistency in document</li>
               <li>Re-evaluating the composition</li>
               <li>Easy-to-follow content flow </li>
               <li>Customer feedback consideration</li>
             </ul>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="git wdt-80">
          <h3>Experience the unbeatable expertise of our details master:</h3>
          <p>Our professionals not only detect and improve the errors, rather we make sure all the ducks are in a row, matching the tiniest of the content element with its content flow and structure. </p>
        </div>
      </div>
    </div>
    <div class="row ultimate-slider">
      <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="git-main">
          ...
          <div class="git-box2">
            <h3>First language editors: </h3>
            <p>No, we don’t use computerised editors and online tools. We still believe in human intelligence and the marvels it can create—we are flesh and blood experts.</p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="git-main">
          ...
          <div class="git-box2">
            ...
            <p>Yes, we use and employ high-grade security standards and measures to keep your document protected—we respect confidentiality.</p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="git-main">
          ...
          <div class="git-box2">
            ...
            <p>No, we don’t leave a single stone unturned to boost the quality of your work—we follow rigorous processes.</p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="git-main">
          ...
          <div class="git-box2">
            ...
            <p>Yes, we don’t just clean the errors; rather, we give your manuscript the shape of a comprehensible document—we help increase appeal by margins. </p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="git-main">
          ...
          <div class="git-box2">
            <h3>Diversity:</h3>
            <p>No, we don’t accept a single type of document; rather, we offer expertise on extensive categories of fields and subjects—we love variety in work. </p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="git-main">
          ...
          <div class="git-box2">
            <h3>File handling:</h3>
            <p>Yes, we don’t own copyrights to any of your work submitted for editing—we handle it extra care. </p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        <div class="wrapper ltus-hlp-sced">
          <h3>Giving the logical flow and extra flair to your wordsmithery:</h3>
          <p>We double-check everything to leave no err, and room for improvement unhandled. We string together every aspect that goes into creating a masterpiece.</p>
