...
<meta name="twitter:url" content="https://thecontentmaestros.com/our-services/guest-blogging"/>                    
...
<!--              <input type="hidden" id="location" name="locationURL" value="http://thecontentmaestros.com/our-services/guest-blogging" />-->
<!--               </div>-->
...
<input type="hidden" name="route" value="<?= $_SERVER['REQUEST_URI']?>">   
                  ...
                  <input type="text" class="jun"  name="gender" > 
                    ...
                    <div class="row">
                      ...
                      <input type="hidden" name="hiddencapcha" value="">
                      <input type="hidden" id="flocation" name="locationURL" value="http://thecontentmaestros.com/our-services/guest-blogging" />
                        </div>
                      </div>
                    </div>
                  </form>
...
<section class="main-princing-sec-hme main-portfolio-sec sec-padding-60 main-srv-prc " cntr-mod>
  <div class="container">
    ...
    <div class="row" center>
      ...
      <!--        <p><a class="cht-wdht-us" href="javascript:;" onclick="setButtonURL();" target="_self">Chat with Us</a> <a href="tel:+13232838204" class="confused"> <i class="icon-phone2"></i>Talk With Us</a></p>-->
      <!--      </div>-->
      <!--      <a href="http://thecontentmaestros.com/order?pack=57" class="btn-main odr-plce">Place Your Order Now</a>-->
      <!--    </div>-->
      <!--  </div>-->
      <!--</div>-->
    </div>
