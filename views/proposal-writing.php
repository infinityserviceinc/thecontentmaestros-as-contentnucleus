...
<meta name="twitter:url" content="https://thecontentmaestros.com/our-services/proposal-writing"/>                  
...
<!--              <input type="hidden" id="location" name="locationURL" value="http://thecontentmaestros.com/our-services/proposal-writing" />-->
<!--               </div>-->
...
<input type="hidden" name="route" value="<?= $_SERVER['REQUEST_URI']?>">   
                  ...
                  <input type="text" class="jun"  name="gender" > 
                    ...
                    <div class="row">
                      ...
                      <input type="hidden" name="hiddencapcha" value="">
                      <input type="hidden" id="flocation" name="locationURL" value="http://thecontentmaestros.com/our-services/proposal-writing" />
                        </div>
                      </div>
                    </div>
                  </form>
