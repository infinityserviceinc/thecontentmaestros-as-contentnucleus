...
<meta name="twitter:url" content="https://thecontentmaestros.co.uk/our-services/resume-writing"/>                   
  

<meta property="og:title" content="We Provide Professional Resume Writing Services | CCW" />
<meta property="og:type" content="article"/>
<meta property="og:url" content="https://thecontentmaestros.co.uk/our-services/resume-writing"/>
...
<!--              <input type="hidden" id="location" name="locationURL" value="http://thecontentmaestros.co.uk/our-services/resume-writing" />-->
<!--               </div>-->
...
<input type="hidden" name="route" value="<?= $_SERVER['REQUEST_URI']?>">   
                  ...
                  <input type="text" class="jun"  name="gender" > 
                    ...
                    <div class="row">
                      ...
                      <input type="hidden" name="hiddencapcha" value="">
                      <input type="hidden" id="flocation" name="locationURL" value="http://thecontentmaestros.co.uk/our-services/resume-writing" />
                        </div>
                      </div>
                    </div>
                  </form>
