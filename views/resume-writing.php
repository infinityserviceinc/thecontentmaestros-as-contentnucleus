...
<body class="ghostwriting-page prs_pge">
                            ...
                            <div class="col-lg-12">
                              <div class="fldset">
                                ...
                                <input type="hidden" id="location" name="locationURL"
                                  value="http://thecontentmaestros.com/our-services/resume-writing" />
                              </div>
                            </div>
                          </div>
                        </form>
  ...
  <!-- <section class="main-ghst-writng-first-sec sec-padding-60"
    style="background-image: linear-gradient(to top left, #3b393c 0%,#59565a 100%);">
    <div class="container">
      <div class="row">
          ...
          <div class="container align-self-center">
            <div class="row">
              <div class="banner_left align-items-center">
                <h1>Adept Resume Writing Services
                  <!-- <span id="typed" style="white-space:pre; color:#2e3390;" class="typed"></span><span
                    class="typed-cursor"></span> -->
                </h1>
                <p class="text-center">
                  We have professional resume writers that can create resumes based on client's job requirements.
                </p>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12">
          <div class="wy-chseus-heading">
            <h3>Why choose us?</h3>
            <p>Our crafted resumes not only reflect your true value proposition, but it also highlights your unique
              attributes. </p>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="wrapper ltus-hlp-sced">
            ...
            <p>We draft resumes from the recruiter’s perspective. Get in touch with our resume creators and avail the
              chance to get more interviews and more job opportunities. </p>
