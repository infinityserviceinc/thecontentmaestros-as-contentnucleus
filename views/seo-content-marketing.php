...
<body class="ghostwriting-page seo_pge">
                            ...
                            <div class="col-lg-12">
                              <div class="fldset">
                                ...
                                <input type="hidden" id="location" name="locationURL"
                                  value="http://thecontentmaestros.com/our-services/seo" />
                              </div>
                            </div>
                          </div>
                        </form>
  ...
  <!-- <section class="main-ghst-writng-first-sec sec-padding-60"
    style="background-image: linear-gradient(to bottom right,#003f4a 0%, #086d80 100%);">
    <div class="container">
      <div class="row">
          ...
          <div class="container align-self-center">
            <div class="row">
              <div class="banner_left align-items-center">
                <h1>
                  SEO Writing Done Proficiently
                  <!-- <span id="typed" style="white-space:pre; color:#2e3390;" class="typed"></span><span
                    class="typed-cursor"></span> -->
                </h1>
                <p class="text-center">
                  Our team specializes in diverse writing, delivering quality results and content that converts.
                </p>
                <!-- <h4 class="sf-txt">
                  Starting from only 
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="wrapper ltus-hlp-sced">
            ...
            <p>We provide you with the expertise of writers specialising in every writing style and niche. Ramp up your
              content rankings and build a great online reputation. </p>
