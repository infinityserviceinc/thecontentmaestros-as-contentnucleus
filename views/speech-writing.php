...
<meta name="twitter:url" content="https://thecontentmaestros.co.uk/our-services/speech-writing"/>                    
...
<meta property="og:url" content="https://thecontentmaestros.co.uk/our-services/speech-writing"/>
...
<!--              <input type="hidden" id="location" name="locationURL" value="http://thecontentmaestros.co.uk/our-services/speech-writing" />-->
<!--               </div>-->
...
<input type="hidden" name="route" value="<?= $_SERVER['REQUEST_URI']?>">   
                  ...
                  <input type="text" class="jun"  name="gender" > 
                    ...
                    <div class="row">
                      ...
                      <input type="hidden" name="hiddencapcha" value="">
                      <input type="hidden" id="flocation" name="locationURL" value="http://thecontentmaestros.co.uk/our-services/speech-writing" />
                        </div>
                      </div>
                    </div>
                  </form>
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        <div class="wrapper ltus-hlp-sced">
          ...
          <p>At The Content Maestros, we minimise the chance of you making any mistake in conveying your idea and points. </p>
