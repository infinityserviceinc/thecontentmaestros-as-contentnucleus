                            ...
                            <div class="col-lg-12">
                              <div class="fldset">
                                ...
                                <input type="hidden" id="location" name="locationURL"
                                  value="http://thecontentmaestros.com/our-services/speech-writing" />
                              </div>
                            </div>
                          </div>
                        </form>
...
<!-- 
  <section class="main-ghst-writng-first-sec sec-padding-60"
    style="background-image: linear-gradient(to top left, #627b9e 0%,#4a5869 100%);">
    <div class="container">
      <div class="row">
          ...
          <div class="container align-self-center">
            <div class="row">
              <div class="banner_left align-items-center">
                <h1>Custom Speech Writing Services For You
                  <!-- <span id="typed" style="white-space:pre; color:#2e3390;" class="typed"></span><span
                    class="typed-cursor"></span> -->
                </h1>
                <p class="text-center">
                  From wedding toasts to business speeches, our writers will make your every word count.
                </p>
                <!-- <h4 class="sf-txt">
                  Starting from only 
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="wrapper ltus-hlp-sced">
            ...
            <p>At The Content Maestros, we minimise the chance of you making any mistake in conveying your idea and
              points. </p>
