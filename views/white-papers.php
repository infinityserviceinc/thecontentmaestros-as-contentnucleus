...
<meta name="twitter:url" content="https://thecontentmaestros.co.uk/our-services/white-papers"/>                  


<meta property="og:title" content="White Paper Content Writing Agency in UK | CCW" />
<meta property="og:type" content="article"/>
<meta property="og:url" content="https://thecontentmaestros.co.uk/our-services/white-papers"/>
...
<!--              <input type="hidden" id="location" name="locationURL" value="http://thecontentmaestros.co.uk/our-services/white-papers" />-->
<!--               </div>-->
...
<input type="hidden" name="route" value="<?= $_SERVER['REQUEST_URI']?>">   
                  ...
                  <input type="text" class="jun"  name="gender" > 
                    ...
                    <div class="row">
                      ...
                      <input type="hidden" name="hiddencapcha" value="">
                      <input type="hidden" id="flocation" name="locationURL" value="http://thecontentmaestros.co.uk/our-services/white-papers" />
                        </div>
                      </div>
                    </div>
                  </form>
