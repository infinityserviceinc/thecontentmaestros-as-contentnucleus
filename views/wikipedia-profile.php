...
<meta name="description" content="Planning to create a Wikipedia page? CCW's expert team knows how to make a Wikipedia page or can also help you with your own  Wikipedia page creation in Hemel Hempstead, Hertfordshire.">
...
<meta name="twitter:url" content="https://contentnucleus.co.uk/our-services/wikipedia-profile"/>                   
...
<meta property="og:url" content="https://contentnucleus.co.uk/our-services/wikipedia-profile"/>
...
<body class="ghostwriting-page wiki-page">
...
<!--              <input type="hidden" id="location" name="locationURL" value="http://contentnucleus.co.uk/our-services/wikipedia-profile" />-->
<!--               </div>-->
...
<input type="hidden" name="route" value="<?= $_SERVER['REQUEST_URI']?>">   
                  ...
                  <input type="text" class="jun"  name="gender" > 
                    ...
                    <div class="row">
                      ...
                      <input type="hidden" name="hiddencapcha" value="">
                      <input type="hidden" id="flocation" name="locationURL" value="http://contentnucleus.co.uk/our-services/wikipedia-profile" />
                        </div>
                      </div>
                    </div>
                  </form>
...
<section class="main-ghst-writng-first-sec sec-padding-60" style="background-image: linear-gradient(to bottom right, #29484a 0%,#85a4a6 100%);">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="ghst-writng-content">
           <h1>Wikipedia Page Writing & Creation Services to Get Listed on Wikipedia</h1>
           <p>Wikipedia and ccw officially brings you the opportunity to become a part of the World’s Largest Encyclopedia</p>
...
<section class="main-ghst-writng-thierd-sec sec-padding-60 main-upa-img-sec">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="thierd-sec-img">
          <figure>
            <img src="../assets/images/services/wikipedia-profile/setting-up-a-profile-page.png" alt="" />
          </figure>
        </div>
      </div>
      <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="thierd-sec-content">
          ...
          <p>At Content Nucleus, our writers set up your profile page to help your boost your digital presence. Prior to creating your page, we perform extensive research to gather maximum information and understand about your overall business requirement</p>
          <a href="order/" class="btn-theme">Let’s Get Started</a>
        </div>
      </div>
    </div>
...
<!--<section class="collaboration-sec main-mkng-img-sec">-->
<!--  <div class="container">-->
<!--    <div class="row align-items-center">-->
<!--      <div class="col-lg-6 col-md-6 col-sm-12">-->
<!--        <div class="wrapper">-->
<!--          <h3>Making sure your wikipedia profile looks credible</h3>-->
<!--          <h2>Why Is A Wikipedia Page Important?</h2>-->
...
<!--      <div class="col-lg-6 col-md-6 col-sm-12">-->
<!--        <figure>-->
<!--          <img src="../assets/images/services/wikipedia-profile/why-is-a-wikipedia.png">-->
<!--        </figure>-->
<!--      </div>-->
<!--    </div>-->
<!--  </div>-->
