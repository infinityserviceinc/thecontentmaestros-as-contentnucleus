...
<body class="ghostwriting-page wiki-page">
                            ...
                            <div class="col-lg-12">
                              <div class="fldset">
                                ...
                                <input type="hidden" id="location" name="locationURL"
                                  value="http://thecontentmaestros.com/our-services/wikipedia-profile" />
                              </div>
                            </div>
                          </div>
                        </form>
  ...
  <!-- <section class="main-ghst-writng-first-sec sec-padding-60"
    style="background-image: linear-gradient(to bottom right, #29484a 0%,#85a4a6 100%);">
    <div class="container">
      <div class="row">
          ...
          <div class="container align-self-center">
            <div class="row">
              <div class="banner_left align-items-center">
                <h1>Finest Wikipedia Services
                  <!-- <span id="typed" style="white-space:pre; color:#2e3390;" class="typed"></span><span
                    class="typed-cursor"></span> -->
                </h1>
                <p class="text-center">
                  We are a Wikipedia business page creation company that takes the data-driven approach.
                </p>
                <!-- <h4 class="sf-txt">
                  Starting from only 
